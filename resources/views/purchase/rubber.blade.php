          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12  ">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br>
    <form id="demo-form2" action="{{ route('rubber.store') }}" method="post"  class="align-items-center w-100 flex-wrap d-flex form-horizontal form-label-left" novalidate="">
                    @csrf
                    ...
                    <div id="input-fields-container" class="align-items-end w-100 flex-wrap">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-1">
                            ...
                            <input type="number" title="0" name="kilogram[]" class="form-control get-rate-bill kilogram" id="kilogram-0" >
                            @error('kilogram.0') 
                                <span class="text-red-500 text-danger"> field is required</span> 
                            @enderror
                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-1">
                            ...
                            <input type="number" title="0" name="sheet[]" class="form-control get-rate-bill sheet " id="sheet-0" >
                            @error('sheet.0') 
                                <span class="text-red-500 text-danger"> field is required</span> 
                            @enderror
                        </div>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-2">
                            <label class="form-label">Quantity <small>In Inches</small></label>
                            <input type="number" title="0" name="qty[]" class="form-control " id="quantity-0" >
                            @error('qty.0') 
                                <span class="text-red-500 text-danger"> field is required</span> 
                            @enderror
                        </div>
              ...
              document.addEventListener('DOMContentLoaded', () => {
                  ...
                  function addNewFields() {
                      ...
                      let innerContent = `
                          <div class="col-12 col-sm-6 col-md-4 col-lg-2">
                              <label for="raw-material" class="form-label">Raw Material</label>
                              <select name="raw_material_id[]" title="${counter}" id="raw-material-${counter}" class="form-control custom_s rawMaterialId">
                                  <option value="default" selected disabled>Select</option>
                                   @if($raw) 
                                    @foreach ($raw as $d)
                                        <option value="{{ $d->raw_material_id }}" >{{ $d->name }}</option>
                          ...
                          <div class="col-12 col-sm-6 col-md-4 col-lg-1">
                              <label for="quantity" class="form-label">Kilogram</label>
                              <input type="number" name="kilogram[]" title="${counter}" class="form-control 
                              get-rate-bill kilogram " id="kilogram-${counter}" >
                              @error('kilogram.${counter}')
                                  <span class="text-red-500 text-danger">{{ $message }}</span>
                              @enderror
                          </div>
                          <div class="col-12 col-sm-6 col-md-4 col-lg-1">
                              <label for="quantity" class="form-label">Sheet</label>
                              <input type="number" name="sheet[]" title="${counter}" class="form-control get-rate-bill sheet "  id="sheet-${counter}">
                              @error('sheet.${counter}')
                                  <span class="text-red-500 text-danger">{{ $message }}</span>
                              @enderror
                          </div>
                          <div class="col-12 col-sm-6 col-md-4 col-lg-2">
                              ...
                              <input type="number" name="qty[]" title="${counter}" class="form-control " id="quantity-${counter}" >
                              @error('qty.${counter}')
                                  <span class="text-red-500 text-danger">{{ $message }}</span>
                              @enderror
                          </div>
