      ...
      <div class="row">
        ...
        <div class="col-md-12 col-sm-12  ">
          <div class="x_panel">
            ...
            <div class="x_content">
              <br>
              <form id="demo-form2" action="{{route('vendors.store')}}" method="post" data-parsley-validate="" class="w-100   flex-wrap d-flex form-horizontal form-label-left" novalidate="">
                @csrf
                ...
                <div class="mb-3 col-12 col-md-4">
                  ...
                  <input type="number" name="cnic" class="form-control  {{ $errors->has('cnic') ? 'is-invalid' : '' }}" value="{{ old('cnic') }}">
                   @error('cnic') <span class="text-red-500 text-danger">{{ $message }}</span> @enderror
                </div>
                <div class="mb-3 col-12 col-md-4">
                ...
                <div class="mb-3 col-12 col-md-4">
                  ...
                  <input type="number" name="op_balance" class="form-control {{ $errors->has('op_balance') ? 'is-invalid' : '' }}" value="{{ old('op_balance') }}">
