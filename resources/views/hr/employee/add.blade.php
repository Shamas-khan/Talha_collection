            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2"  action="{{route('employee.store')}}" method="post" class="w-100   flex-wrap d-flex form-horizontal form-label-left" novalidate="">
                      @csrf
                      ...
                      <div class="mb-3 col-12 col-md-5">
                        ...
                        <input type="text" name="basicsalary" id="basicsalary" class="form-control {{ $errors->has('basicsalary') ? 'is-invalid' : '' }}" value="{{ old('basicsalary') }}">
