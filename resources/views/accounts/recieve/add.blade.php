            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" action="{{ route('recieve.store') }}" method="post" class="w-100 flex-wrap d-flex form-horizontal form-label-left" novalidate="">
                      @csrf
                                    ...
                                    success: function(data) {
                                        ...
                                        $.each(data, function(index, item) {
                                          if(item.running){
                                            ...
                                            $personSelect.append('<option value="' + item.id + '">' + item.name + ' <small>' + formattedRunning + '</small>' + '</option>');
                                          }
                                          else{
