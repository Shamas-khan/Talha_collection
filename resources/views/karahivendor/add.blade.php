        ...
        <div class="col-md-12 col-sm-12  ">
          <div class="x_panel">
            ...
            <div class="x_content">
              ...
              <form id="demo-form2" action="{{route('karahivendor.store')}}" method="post" data-parsley-validate="" class="w-100   flex-wrap d-flex form-horizontal form-label-left" novalidate="">
                @csrf
